 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_View_Helper_FormMultiText extends  Zend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
        ...
        $options = null, $listsep = "<br />\n")
    {
        ...
        foreach ($options as $opt_value => $opt_label) {
            ...
            $radio = '<label'
                    ...
                    . (('prepend' == $labelPlacement) ? $opt_value : '')
                    . '<input type="' . $this->_inputType . '"'
                    . ' name="' . $name . '"'
                    . ' id="' . $optId . '"'
                    . ' value="' . $this->view->escape($opt_label) . '"'
                    . $disabled
                    . $this->_htmlAttribs($attribs)
                    . $endTag
                    . (('append' == $labelPlacement) ? $opt_value : '')
                    . '</label>';
