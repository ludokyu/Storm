                    ...
                    $taille=($is_taille)? $tab_taille[$val->taille]:"";
                     ...
                     $this->NewElement("select","id_plat_$i","1 $nom_cat $taille",$param_element);
                       ...
                       $this->NewElement("hidden","id_menu_$i","",array("order"=>($count+3),"value"=>$val->id_menu));
                            ...
                            if($c[0]["is_compo"]){
                                 $this->NewElement("hidden","ingt_plus_$i","",array("decorator"=>array("Description"=>array("class"=>"pre")),"order"=>($count+4),"value"=>0,"description"=>"null"));

                                  $this->NewElement("hidden","ingt_moins_$i","",array("decorator"=>array("Description"=>array("class"=>"pre")),"order"=>($count+5),"value"=>0,"description"=>"null"));
