...
class Storm_Form_Default extends Zend_Form{
  ...
  public function NewElement($type, $name, $label, $param=array()){
    ...
    switch($type){
      ...
      default:
        ...
        $default=array("text", "hidden", "textarea", "password", "select", "radio", "button", "reset", "file", "submit", "selectattrib", "DoubleMultiCheckbox", "MultiCheckbox","multicheckbox", "html","multitext");
